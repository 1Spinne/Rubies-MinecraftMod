...
public class RubyMod implements ModInitializer {
	...
	private static ConfiguredFeature<?, ?> RUBY_ORE_OVERWORLD = Feature.ORE.configure(new OreFeatureConfig(OreFeatureConfig.Rules.BASE_STONE_OVERWORLD, ModBlocks.RUBY_ORE.getDefaultState(), 4))
	...
	public void onInitialize() {
		...
		RegistryKey<ConfiguredFeature<?,?>> rubyOreOverworld = RegistryKey.of(Registry.CONFIGURED_FEATURE_KEY, new Identifier("rubies", "ruby_ore_overworld"));
